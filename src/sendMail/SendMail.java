...
public class SendMail {
	...
	public static String send(String mailAddress, String theme, String fromName, String receiveName, String content)
			throws Exception {
...
//        props.setProperty("mail.smtp.socketFactory.port", smtpPort);
		...
		// 4. 发送邮件, 发到所有的收件地址, message.getAllRecipients() 获取到的是在创建邮件对象时添加的所有收件人, 抄送人,
		// 密送人
